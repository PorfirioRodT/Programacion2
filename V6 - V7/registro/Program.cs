    ...
    class Program
    {
               ...
               }  else
               {
                   ...
                   foreach (var line in list)
                   {
                       ...
                       if (list.IndexOf(line) > 0){
                           ...
                           var people = Datos.FromCsvLine(line);
        ...
        public static void Search(){
            ...
            if (per == null){
                ...
                Console.WriteLine("No se encontro esa cedula");
        ...
        public static void Edit(){
            ...
            var people = Datos.GetAPerson(id);
            ...
            if (people == null)
            {
                ...
                people = Datos.FromCsvLine(Information(id));
                Console.WriteLine(people.UpdatingPerson());
        ...
        public static void Delete(){
            ...
            if (people == null)
            {
                ...
                Console.WriteLine(people.ToString());
                Console.WriteLine(people.DeleteFromCsv(id));
